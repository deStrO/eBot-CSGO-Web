...
<script>
    $(document).ready(function() {
        ...
        $('.email').each(function() {
            $(this).html('<a href="mailto:' + $(this).attr('data-attr') + '" target="_blank">' + $(this).attr('data-attr') + '</a>');
        })
    });
</script>
...
<div class="well" style="overflow:hidden; min-height: 497px;">
    <div class="row-fluid">
        ...
        <div class="span9">
            <h4>Production</h4>
                <p>
                <i class="icon-arrow-right" style="margin-right: 8px;"></i>Julien 'destrO' Pardons - <span class="email" data-attr="destro@esport-tools.net">(destro [at] esport-tools.net)</span><br>
            ...
            <p>
                <i class="icon-arrow-right" style="margin-right: 8px;"></i>Fabian 'Basert' Gruber - <span class="email" data-attr="basert@esport-tools.net">(basert [at] esport-tools.net)</span><br>
                <em style="margin-left: 22px;">Programming &amp; Development</em><br>
    ...
    <div class="row-fluid">
        ...
        <div class="span9">
            <h4>Help &amp; Support</h4>
            If you need support using the eBot, the best way is to check out our forums. Just visit <a href="http://www.esport-tools.net" target="_blank">http://www.esport-tools.net</a>
            <h4>License</h4>
