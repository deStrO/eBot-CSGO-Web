                                ...
                                <div class="progress progress-striped" style="width: 450px;">
                                    <?php foreach ($data as $d): ?> 
                                        <?php if ($d["type"] == "seperator"): ?>
                                            <div class="bar bar-warning needTips" title="<?php echo __("Changement de side"); ?>" style="width: <?php echo $size * 1; ?>px;" >
                                            </div>
                                        <?php else: ?>
        ...
        <div class="tab-pane" id="logs">
            <div class="well" id="logs">
                <div style="height: 400px; overflow: auto;">
                    <div  id="logmatch">
                        <?php echo file_get_contents(sfConfig::get("app_log_match_admin") . "/match-" . $match->getId() . ".html"); ?>
                    </div>
                    <div id="end"></div>
                </div>
            </div>
