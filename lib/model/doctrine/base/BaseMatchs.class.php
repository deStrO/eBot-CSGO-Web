 ...
 * @method Configs             getConfig()                      Returns the current record's "Config" value
 ...
 * @method Matchs              setConfigId()                    Sets the current record's "config_id" value
 ...
 * @method Matchs              setConfig()                      Sets the current record's "Config" value
...
abstract class BaseMatchs extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('config_id', 'integer', 20, array(
             'type' => 'integer',
             'length' => 20,
             ));
    ...
    public function setUp()
    {
        ...
        $this->hasOne('Configs as Config', array(
             'local' => 'config_id',
             'foreign' => 'id',
             'onDelete' => 'SET NULL'));
