...
abstract class BasePlayersHeatmapFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'event_x'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'event_y'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'event_z'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'attacker_x'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'attacker_y'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'attacker_z'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
