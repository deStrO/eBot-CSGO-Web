...
abstract class BasePlayersHeatmapForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'event_x'       => new sfValidatorInteger(array('required' => false)),
      'event_y'       => new sfValidatorInteger(array('required' => false)),
      'event_z'       => new sfValidatorInteger(array('required' => false)),
      ...
      'attacker_x'    => new sfValidatorInteger(array('required' => false)),
      'attacker_y'    => new sfValidatorInteger(array('required' => false)),
      'attacker_z'    => new sfValidatorInteger(array('required' => false)),
